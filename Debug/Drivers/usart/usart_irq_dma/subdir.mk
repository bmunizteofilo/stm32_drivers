...
C_SRCS += \
../Drivers/usart/usart_irq_dma/usart_irq_dma.c 

OBJS += \
./Drivers/usart/usart_irq_dma/usart_irq_dma.o 

C_DEPS += \
./Drivers/usart/usart_irq_dma/usart_irq_dma.d 


# Each subdirectory must supply rules for building sources it contributes
Drivers/usart/usart_irq_dma/%.o Drivers/usart/usart_irq_dma/%.su Drivers/usart/usart_irq_dma/%.cyclo: ../Drivers/usart/usart_irq_dma/%.c Drivers/usart/usart_irq_dma/subdir.mk
...
clean: clean-Drivers-2f-usart-2f-usart_irq_dma

clean-Drivers-2f-usart-2f-usart_irq_dma:
	-$(RM) ./Drivers/usart/usart_irq_dma/usart_irq_dma.cyclo ./Drivers/usart/usart_irq_dma/usart_irq_dma.d ./Drivers/usart/usart_irq_dma/usart_irq_dma.o ./Drivers/usart/usart_irq_dma/usart_irq_dma.su

.PHONY: clean-Drivers-2f-usart-2f-usart_irq_dma
